...
function About() {
    return <div className='portfolio'>
      ...
      <h1 className='title'>About Me</h1>
          <p>I am a final year under-graduate currently pursuing my bachelors in Computer Science and Engineering from LPU, Jalandhar. I am a web dev enthusiast and have been practicing HTML, CSS and Js since my first semester.</p>
          <p>I have build many frontend projects using ReactJs/NextJS, Tailwind CSS, Firebase which are mentioned in the portfolio section. Built some website clones which really helped me to understand the concepts of react and redux which includes hooks, state, context and routing. Few clones are - Amazon, Airbnb, CRED, Tesla, Whatsapp, Google Calendar, netflix.</p>
          <p>I have also done an internship from internshala where I contributed on the frontend part of their website from scratch. I learnt about the component tree structure of the website and how the data flow from one part of the website to other. Implemented the concept Redux state management to keep a global state which can be easily access throughout the website.</p>
