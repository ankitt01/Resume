...
function About() {
    return <div className='portfolio'>
      ...
      <h1 className='title'>About Me</h1>
          <p>I am a final year under-graduate currently pursuing my bachelors in Computer Science and Engineering from LPU, Jalandhar. I am a web dev enthusiast and have been practicing HTML, CSS and Js since my first semester. I have build many frontend projects using ReactJs/NextJS, Tailwind CSS, Firebase which are mentioned in the portfolio section. Built some website clones which really helped me to understand the concepts of react and redux which includes hooks, state, context and routing. Few clones are - Amazon, Airbnb, CRED, Tesla, Whatsapp, Google Calendar, netflix. </p>
